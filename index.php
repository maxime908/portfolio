    ...
    <section id="contact" class="margin-section">
        ...
        <div id="contact-content">
            ...
            <div id="info-content" class="robotoMono">
                ...
                <a href="https://www.instagram.com/game_of_max_/" target="_blank" class="perspective-button">
                    <div class="hexagone-effect position-relative view">
                        <p class="hexagone color-1">
                ...
                <a href="CV-Drezet-Maxime.pdf" download="CV Drezet Maxime.pdf" class="perspective-button">
                    <div class="hexagone-effect position-relative view">
                        <p class="hexagone color-1">
